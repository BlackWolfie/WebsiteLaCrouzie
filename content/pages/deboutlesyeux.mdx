...
blocks:
  ...
  - tagline: ''
    headline: Evènements mensuels
    text: >
      L'association Debout les Yeux a la volonté de diffuser la culture en
      milieu rural. Pour cela, elle propose chaque mois un concert ou spectacle
      en variant constamment les styles de musique ou les thématiques.
    imagePlus:
